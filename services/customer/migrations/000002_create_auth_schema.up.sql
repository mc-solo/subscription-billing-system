...
) ENGINE=InnoDB DEFAULT CAHRSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- link users to the existing customers table
alter table customersadd column user_id char(36) null after id,
...
create table if not exists user_auth_audit_logs (
    id bigint primary key auto_increament,
